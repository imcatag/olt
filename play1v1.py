...
def play_1v1(agent1_weights_path: str, agent2_weights_path: str, games_count=32):
    results = ""
    for _ in range(games_count):
        ...
        agent1 = DQNAgent(play_mode=True, model_name=agent1_weights_path)
        agent2 = DQNAgent(play_mode=True, model_name=agent2_weights_path)
...
# results = play_1v1('king.hdf5', 'graphing_weights/episode_25.hdf5')
# print(results)
